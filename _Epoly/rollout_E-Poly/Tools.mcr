...
(
	...
	_edges	= Epoly.getAusingB #Edge #Face _faces[1]
	...
	_mod.ConvertSelection #Vertex #Edge

	_mod.ButtonOp #ShrinkSelection
	
	_edges_ridge	= (Epoly.getSel #Edge)[1]

	Epoly.setSel #edge _edges_ridges
